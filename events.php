...
<head>
 ...
 <linK rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <title>BALINGASAG WEB COMMUNITY EVENTS</title>
...
<br>
 ...
 <div class="row content">
    <div class="col-sm-4 sidenav">
        ...
        <li class="active"><a href="events.php">PROGRAMS AND EVENTS</a></li>
...
if($link === false){
	...
	$query="select * from posts where tag='events' order by 'date' DESC";
