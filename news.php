...
<head>
    ...
    <title>BALINGASAG WEB COMMUNITY NEWS</title>
...
<div class="panel panel-success">
  ...
  <div class="panel-body">
    <h4 style="text-indent:50px"><?php echo $desc; ?></h4>
  </div>
  ...
  <div class="panel-footer">
      ...
      <button type="submit" class="btn btn-primary" name="comments" align="right" >Submit</></button>
        </div>
      <hr>
