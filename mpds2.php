...
<linK rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <title>BALINGASAG WEB COMMUNITY MPDC</title>
         ...
         <ul class="dropdown-menu">
          <li><a href="agri1.php">AGRICULTURE</a></li>
           <li><a href="BIDS2.php">BIDS</a></li>
            ...
            <li class="active"><a href="mpds2.php">MPDC OFFICE</a></li>
...
<center><p><h3>Contact No: 09066056287</h3></p></center>
 <div class="header">
  <div class="mark2">
  <em><a href="#">MUNICIPAL PLANNING AND DEVELOPMENT COORDINATOR OFFICE</a></em>
  <p><em>Mandate:</em> Planning arm of the Local Government Unit of Balingasag</p>
   <p><em>Mission:</em> To promote a coordinated planning system to Decision-maker</p>
    <p><em>Organization Outcome:</em> Function & Responsive Planning Office</p>
</div>
</div>

<div class="topnav">
  <em><a href="#services">MAJOR PROGRAMS,PROJECTS AND ACTIVITIES</a></em>
</div>
  </section>
  <div class="mark2">
      <ol>
        <h4><li> Formulation of Comprehensive Land Use Plan</li>
        <li> Formulation of Comprehensive Development Plan</li>
        <li> Consolidation of Local Development Investment Program (LDIP)</li>
        <li> Consolidation of Annual Investment Program (AIP)</li>
        <li> Assists in the Formulation of Municipality and Barangay Plans</li>
        <li> Formulation of Projects Proposals</li>
        <li> Project Monitoring and Evaluation</li>
        <li> Implementation of Local Zoning Ordinance</li>
        <li> Implementation of Housing Projects</li>
        <li> Updating of Municipal Profile</li></h4>
      </ol>
</div>
</div>
