         ...
         <ul class="dropdown-menu">
          <li><a href="agri.php">AGRICULTURE</a></li>
           <li><a href="BIDS.php">BIDS</a></li>
            ...
            <li class="active"><a href="dilg.php">DILG</a></li>
...
<br>
      <ol>
        <h4><p> Fruit of Labor</p>
             <h4><p> #DILGBALINGASAG</p>
                 <h4><p> #BALINGASAGMYHOME</p>
        <img src="img/dilgcongrats.jpg" style="height: 50%; width: 50%; ">
        </h4>
      </ol>
