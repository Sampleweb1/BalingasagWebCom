            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="lead active">
                        ...
                        <li>
					  <a href="userlogout.php" onclick="javascript:return confirm('Are you sure you want to log out?');"><span class="glyphicon glyphicon-log-in"></span> Log out</a>
					  </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
...
$query =  "SELECT * FROM posts WHERE title LIKE '%$name%' OR author LIKE '%$name%'";  
 ...
 $result = mysqli_query($link,$query);
  ...
  <div class="panel-body">
    <p style="text-indent:50px"><?php echo $desc; ?></p>
  </div>
	...
	<footer>
            <div class="row">
                <div class="col-lg-12 alert alert-success">
                    <p>Contact us @ BalingasagMisOr@gmail.com <a href="http://www.gmail.com"></a></p>
                </div>
            </div>
        </footer>
    <!-- /.container -->
