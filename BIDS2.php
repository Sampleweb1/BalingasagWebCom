        ...
        <div class="droupdown" >
         ...
         <ul class="dropdown-menu">
          <li><a href="agri1.php">AGRICULTURE</a></li>
           <li class="active"><a href="BIDS2.php">BIDS</a></li>
...
<?php } ?>
   ...
   <div align="center" style="background-color: black;width: 100%; height: 600px; border-radius: 20px;">
    <embed style="width:100%; height: 100%;" src="HAHA.pdf" type="application/pdf"></embed>
</div>
</div>
