...
<link rel="stylesheet" href="css2/mpdc.css">
    <!-- Bootstrap Core CSS -->
         ...
         <ul class="dropdown-menu">
          <li><a href="agri1.php">AGRICULTURE</a></li>
           <li><a href="BIDS2.php">BIDS</a></li>
            ...
            <li class="active"><a href="budget2.php">BUDGET OFFICE</a></li>
...
<center><p><h3>Contact Person:Milarso Cagalawan</h3></p>
<p><h3>Phone No: 09161927066</h3></p></center>
<div class="topnav">
  <em><a href="#services"><img src="img/logobudget.jfif" style="height: 50px; width: 50px;">BUDGET OFFICE BALINGASAG</a></em>
</div>
 <br>

  <div class="mark2">
      <ol>
        <h2><p>Pormal nga gipahigayon ang pagtunol sa IP Village adaw'ng Martes, December 21, 2021, Sitio Eva, Brgy. Samay, Balingasag, Misamis Oriental.</p>
        <p>Gipangunahan ni Mayor Alexis S. Quina, Engr. Fe Ancheta , NHA, District Manager CDO-Mis.Or. Atty Pinky Pareja, NHA Commissioner, Datu Cesar Asapon, Sangguniang Bayan Members, ug mga kauban.</p>
        <p>Anaa usab ang mga personahi sa Minergy Power Corporation - Balingasag Station uban nila Ret. General Ed Gurrea, AFP, Sir Dods Tangonan, ug Sir Jonathan Rizalda ug mga kauban, lakip ang personahi sa TESDA -10 si Director Marilou Cherry Garido.</p>
        <p>Anaa usab ang mga personahi sa Minergy Power Corporation - Balingasag Station uban nila Ret. General Ed Gurrea, AFP, Sir Dods Tangonan, ug Sir Jonathan Rizalda ug mga kauban, lakip ang personahi sa TESDA -10 si Director Marilou Cherry Garido.</p>
        <p> Lakip usab nga gitunol ang Energization Project gikan sa Minergy Power Corporation ug ang Handloom Weaving gikan sa TESDA.
</p>
        <p>Usa kini ka joint project sa National Housing Authority (NHA) ug ang Local Government Unit of Balingasag alang sa mga lumad (Pamalihi Tribe) ubos ni Datu Cesar Asapon.
</p>
        <p>People's Palace Photo Bureau</p>
        <p>AAF</p>
       <em><p  href="https://www.facebook.com/hashtag/balingasagmyhome">#BalingasagMYHOME</p>#BalingasagMisOr</p></em><h2>

      
      </ol>
       <img src="img/budget.png" style="height: 40%; width: 80%; ">
</div>
<br>
...
<div class="topnav">
  <em><a href="#serevics"><img src="img/logobudget.jfif" style="height: 50px; width: 50px;">BUDGET OFFICE BALINGASAG</a></em>
</div>
  <div class="mark2">
      <ol>
        <h2><p> HIGHLIGHT: </p>
        <p>IP VILLAGE TURNOVER CEREMONY</p>
        <p>Sitio Eva, Barangay Samay, Balingasag, Misamis Oriental, Tuesday, </p>
        <p>December 21, 2021.</p>
        <p href="https://www.facebook.com/balingasagmyhome2019">#BalingasagMYHOME</p>
        <p>#BalingasagMisOr.</p>
       </h2>
      
      </ol>
         <video  controls height="56.25%" width="100%" loop autoplay>
      <source src="img/budgetoffice.mp4" type="video/mp4">
...
<div class="topnav">
  ...
  <div class="mark2">
      <ol>
        <h2><p> DILG Family </p>
        <p>Balingasag and Lagonglong</p>
        <p>RCSP and Immersion </p>
        <p>The Spot</p>
       </h2>
      
      </ol>
         <img src="img/budgetme.png" style="height: 50%; width: 50%; ">
</div>
</div>
</div>
