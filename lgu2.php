...
<head>
    ...
    <title>BALINGASAG WEB COMMUNITY LGU</title>
...
<ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="lgu2.php">LGU</a></li>
...
if($link === false){
	...
	$query="select * from posts where tag='lgu' order by 'date' DESC";
...
<div class="panel panel-success">
  ...
  <div class="panel-body">
   ...
   <div class="panel-footer">
      ...
      <hr>
      <h5><a href="rdmore2.php?read=<?php echo $newsid;?>">
        <b>View Comments:</b> </a></h5>
