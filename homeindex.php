...
<body style="background-color: #ffffff">
  ...
  <!-- End Hero Section  -->
    <!-- Navigation -->
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="height:15%;">
        <div class="container" >
		
            <!-- Brand and toggle get grouped for better mobile display -->
            <div class="navbar-header">
                  <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" style="background-color: darkred;">
        ...
        <div class="row">
           <div class="col-md-8">
            ...
            <div class="col-md-4" align="left">
                <h3><b contenteditable="true">Welcome</b></h3>
				<br>
               <em> <h4 style="text-indent:50px;margin:10px;padding:5px" align="justify">BALINGASAG WEB COMMUNITY establish a complete entryway for all the  news updates exclusively in the BALINGASAG MISAMIS ORIENTAL</h4>
                <h4 style="text-indent:50px;margin:10px;padding:5px" align="justify"> This Website provides up-to-date news, announcements within the balingasag misamis oriental.</h4></em>
            </div>
            <!-- /.col-md-4 -->
        </div>
        <!-- /.row -->
...
if($link === false){
	...
	$query="SELECT * FROM posts ORDER BY date DESC LIMIT 3 OFFSET 0";
			...
			<div class="col-md-4">
              <div class="thumbnail">
      			...
      			<div class="caption">
        			...
        			<p><a href="rdmore.php?read=<?php echo $news_id;?>"><em>Read More</em> <span class="glyphicon glyphicon-plus">&nbsp;</span></button></a></p>
					 <p><b>Category: <a href="story.php" class="label label-danger" role="button"><?php echo $cat ?></b></a>
      			</div>
    		</div>
            </div>
            <!-- /.col-md-4 -->
...
<ul>Saturday    8AM–4PM</ul>
 ...
 <footer class="footer-ditributed">
    ...
    <div class="modal-container101" id="modal-container101">
        <div class="modal21" id="modal21">
            <button class="close-btn101" id="close101"><i class="fa fa-times"></i></button>
            <div class="modal-content101">
                <div class="header101">
                    <h2 class="logo101">Privacy Policy</h2>
                    <p class="tagline101">Visitors are not allowed to speak negatively to each other,profanity is not allowed and visitors can't pitch their own products within the community</p>
                    <p>We collect and utilize the information that you provide to us voluntarily.
            We may use your information to contact you in the future with promotional offers.
            we will not rent or sell you information into third parties outside company Inc and its group companies(including any parent, subsidiaries and affiliates) without your consent.</p>
                </div>
            </div>
        </div>
    </div>
