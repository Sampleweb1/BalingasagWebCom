...
<head>
    ...
    <title>BALINGASAG WEB COMMUNITY ENGINEERING</title>
...
<ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="engineering1.php">ENGINEERING </a></li>
...
if($link === false){
	...
	$query="select * from posts where tag='ENGINEERING' order by 'date' DESC";
