...
<head>
    ...
    <title>BALINGASAG WEB COMMUNITY CALENDAR</title>
...
<ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="calendarofact1.php">CALLENDAR OF ACTIVITIES</a></li>
...
<div style="background-color: black;width: 67%; height: 600px; border-radius: 20px;">
    <embed style="width:150%; height: 100%;" src="image/calendarPDF.pdf" type="application/pdf"></embed>
  </div>
</div>
