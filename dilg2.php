...
<head>
    ...
    <title>BALINGASAG WEB COMMUNITY SPORT</title>
         ...
         <ul class="dropdown-menu">
          <li><a href="agri1.php">AGRICULTURE</a></li>
           <li><a href="BIDS2.php">BIDS</a></li>
            <li class="active"><a href="dilg2.php">DILG</a></li>
...
<br>
<div class="topnav">
  <em><a href="#services"><img src="img/dilg.png" style="height: 50px; width: 50px; ">DILG BALINGASAG</a></em>
</div>
  </section>
  
      <ol>
        <h4><p> PAHIBALO SA TANAN... ANG ATONG MGA  SEMENTARYO SIRADO GIKAN OCTOBER 29 HANGTOD  NOVEMBER 2, 2021.</p>
        <p>PINASUBAY SA LAGDA SA DILG MEMORANDUM CIRCULAR NO. 2021 - 050 UG SA LOKAL NGA PANGAGAMHANAN SA LUNGSOD SA BALINGASAG PINAAGI SA ASQ - EXECUTIVE ORDER NO. 12,  S. 2021.</p>
        <p>DAGHANG SALAMAT.</p>
        <p>People's Palace Photo Bureau</p>
        <p> AAF</p>
        <p> #BalingasagMyHome 
#BalingasagMisOr 
ctto: Sir William Roa</p>
        </h4>
      </ol>
      <img src="img/dilg1.jpg" style="height: 100%; width: 100%; ">
...
ctto: Sir William Roa</p>
       ...
       <img src="img/dilg2.png" style="height: 40%; width: 50%; ">
      </div>
</div>
</div>
</section>
...
if($link === false){
	...
	$query="select * from posts where tag='dilg' order by 'date' DESC";
...
<div class="panel panel-success">
  ...
  <div class="panel-body">
    <p style="text-indent:30px;margin:5px;padding:5px" align="justify"><?php echo $desc; ?></p>
  </div>
   ...
   <h5><b>Comments:</b></h5>
    <hr>
      ...
      <form role="form">
        ...
        <button type="submit" class="btn btn-success" name="comment">Submit</button>
      </form>
      <br>
